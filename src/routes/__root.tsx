...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Custom 3D Wardrobe Planner" },
      { name: "description", content: "Interactive 3D wardrobe configurator with live pricing." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Custom 3D Wardrobe Planner" },
      {
        property: "og:description",
        content: "Interactive 3D wardrobe configurator with live pricing.",
      },
