...
export const KITCHEN_LAYOUT_PRESETS: KitchenLayoutPreset[] = [
  ...
  {
    id: "kitchen-5-sketch",
    name: "Kitchen 5 · Schiță L",
    description:
      "Layout inspirat din schiță: aproximativ 350 cm pe latura principală, retur de 210 cm și coloană frigorifică.",
    units: [
      // Main run: sink, dishwasher, hob/oven, drawers and preparation space.
      {
        x: -270,
        z: 30,
        w: 60,
      ...
      },
      {
        ...
        countertopMaterial: "stone",
        backsplash: true,
        appliances: [{ id: "k5-dishwasher", type: "dishwasher", y: 4 }],
      },
      {
        x: -150,
        z: 30,
      ...
      // Tall refrigerator column at the opposite end of the main run.
      {
        x: 250,
        z: 30,
        w: 60,
      ...
      // Two 60 cm return units, matching the approximate 210 cm return in the sketch.
      {
        x: -370,
        z: 120,
        rot: 90,
